...
//Rare exceptions to indicate a bug in the _tisocialacsapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TiSocialACSApp proxies.
 */
