...
/**
 Base class for all TiSocialACSApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiSocialACSApp view hierarchy (such as wrapped iOS UIViews) was touched.
