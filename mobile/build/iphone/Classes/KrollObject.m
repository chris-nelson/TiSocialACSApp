...
//@interface TiSocialACSAppObject : NSObject
//@end

@interface TiSocialACSAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiSocialACSAppObject class]])
		{
			for (NSString *key in [[(TiSocialACSAppObject*)o modules] allKeys])
			{
