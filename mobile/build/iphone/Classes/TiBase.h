...
// in simulator we redefine to format for TiSocialACSApp Developer console
...
{\
	NSString * exceptionName = [@"org.tisocialacsapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tisocialacsapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiSocialACSAppNativeItemNone = -1, 
	UITiSocialACSAppNativeItemSpinner = -2,
	UITiSocialACSAppNativeItemProgressBar = -3,
	
	UITiSocialACSAppNativeItemSlider = -4,
	UITiSocialACSAppNativeItemSwitch = -5,
	UITiSocialACSAppNativeItemMultiButton = -6,
	UITiSocialACSAppNativeItemSegmented = -7,
	
	UITiSocialACSAppNativeItemTextView = -8,
	UITiSocialACSAppNativeItemTextField = -9,
	UITiSocialACSAppNativeItemSearchBar = -10,
	
	UITiSocialACSAppNativeItemPicker = -11,
	UITiSocialACSAppNativeItemDatePicker = -12,
	
	UITiSocialACSAppNativeItemInfoLight = -13,
	UITiSocialACSAppNativeItemInfoDark = -14,
	
	UITiSocialACSAppNativeItemDisclosure = -15,
	
	UITiSocialACSAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiSocialACSApp instances of
