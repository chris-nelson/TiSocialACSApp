...
@interface TiSocialACSAppObject : KrollCoverageObject {
#else
@interface TiSocialACSAppObject : KrollObject {
#endif
@private
...
extern NSString * TiSocialACSApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiSocialACSAppObject *_tisocialacsapp;
    KrollObject* console;
	BOOL shutdown;
